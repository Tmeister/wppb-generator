...
export function Hero() {
  ...
  return (
    <>
      <h1 className="font-display mx-auto max-w-4xl text-center text-5xl font-medium tracking-tight text-slate-900 dark:text-white sm:text-7xl">
        WordPress plugin{' '}
        <span className="relative whitespace-nowrap text-blue-600">
          ...
          <span className="relative"> boilerplate</span>
        </span>{' '}
        generator.
      </h1>
